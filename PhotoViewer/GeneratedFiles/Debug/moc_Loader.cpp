...
static const char qt_meta_stringdata_Loader[] = {
    "Loader\0"
};
...
const QMetaObjectExtraData Loader::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Loader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Loader,
      qt_meta_data_Loader, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Loader::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Loader))
